...
export default function NationalParkPage() {
  ...
  const agentData = {
    name: "Ravi Oraon",
    phone: "666666666",
    description: "Expert wildlife guide and naturalist with 15+ years experience in Jharkhand's national parks and safari operations."
  };
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-8 text-white">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">Wildlife expert for {selectedPlace.name}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                <Button 
                  onClick={() => window.open(`https://wa.me/${agentData.phone.replace(/[^0-9]/g, '')}?text=Hi, I'm interested in visiting ${selectedPlace.name}. Can you help me plan my safari?`, '_blank')}
                  variant="outline"
