...
const parkPlaces = [
  {
    ...
    description: "Jubilee Park is one of the largest parks in Jamshedpur, covering an area of over 200 acres. The park features beautiful gardens, walking tracks, a rose garden, and various recreational facilities. It's a perfect place for morning walks, picnics, and family outings.",
    history: "Established in 1958 to commemorate the golden jubilee of Tata Steel, Jubilee Park has been a green lung for the industrial city of Jamshedpur.",
    significance: "The park serves as a major recreational space for the residents of Jamshedpur and is known for its well-maintained gardens and peaceful environment.",
    timings: "5:00 AM - 9:00 PM",
    bestTimeToVisit: "October to March (Pleasant weather)",
    nearbyAttractions: ["Tata Steel Zoological Park", "Dimna Lake", "Dalma Hills"],
    facilities: ["Walking Track", "Children's Play Area", "Rose Garden", "Boating", "Cafeteria", "Parking"]
  },
  {
    id: 2,
    name: "Rock Garden",
    location: "Ranchi, Jharkhand",
    type: "Sculptural Garden",
    rating: 4.0,
    ...
    description: "Rock Garden in Ranchi is a unique sculptural garden featuring artistic rock formations and landscaping. The garden showcases creative use of natural rocks combined with beautiful plantations to create an artistic outdoor space.",
    history: "Created as part of Ranchi's urban development initiatives, the Rock Garden represents the creative fusion of art and nature in the city's landscape.",
    significance: "The garden stands as a testament to innovative urban planning and serves as a popular destination for art lovers and nature enthusiasts.",
    timings: "6:00 AM - 8:00 PM",
    bestTimeToVisit: "November to February (Cool weather)",
    nearbyAttractions: ["Ranchi Lake", "Tagore Hill", "State Museum"],
    facilities: ["Sculptural Art", "Garden Walk", "Photography", "Seating Areas", "Maintenance"]
  }
];
...
export default function ParkPage() {
  const [selectedPlace, setSelectedPlace] = useState(parkPlaces[0]);
  ...
  const agentData = {
    name: "Suresh Kumar",
    phone: "888888888",
    description: "Park ranger and recreation guide with extensive knowledge of Jharkhand's urban parks and recreational facilities."
  };
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Urban <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Parks</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Discover Jharkhand's beautifully landscaped parks and recreational spaces. Perfect for family outings, morning walks, and peaceful retreats in the heart of the city.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            {parkPlaces.map((place) => (
              <Card 
                ...
                className={`cursor-pointer transition-all duration-300 hover:shadow-xl ${
                  selectedPlace.id === place.id ? 'ring-2 ring-green-500 shadow-xl' : ''
                }`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                {selectedPlace.images.map((image, index) => (
                  <div key={index} className={`relative h-20 cursor-pointer overflow-hidden rounded-lg ${index === currentImageIndex ? 'ring-2 ring-green-500' : ''}`} onClick={() => setCurrentImageIndex(index)}>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold text-gray-900 mb-3">About the Park</h3>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-8 text-white">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">Park guide for {selectedPlace.name}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                <Button 
                  onClick={() => window.open(`https://wa.me/${agentData.phone.replace(/[^0-9]/g, '')}?text=Hi, I'm interested in visiting ${selectedPlace.name}. Can you provide information about park facilities?`, '_blank')}
                  variant="outline"
